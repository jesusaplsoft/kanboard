...
return array(
    ...
    'Your category has been created successfully.' => 'Se ha creado tu categoría correctamente.',
    ...
    'There is no user management for personal projects.' => 'No hay gestión de usuarios para proyectos privados.',
    ...
    'No specific user has been allowed.' => 'Ningún usuario ha sido autorizado específicamente.',
    'Role' => 'Rol',
    ...
    'Project owner' => 'Propietario del proyecto',
    'Personal projects do not have users and groups management.' => 'Los proyectos privados no tienen gestión de usuarios y grupos.',
    ...
    'Assigned' => 'Asignado',
    'Task limits apply to each swimlane individually' => 'Los límites para las tareas se aplican a cada carril de forma personalizada',
    'Column task limits apply to each swimlane individually' => 'Los límites para las tareas de columnas se aplican a cada carril de forma personalizada',
    'Column task limits are applied to each swimlane individually' => 'Los límites para las tareas de columnas se aplican a cada carril de forma personalizada',
    'Column task limits are applied across swimlanes' => 'Los límites para las tareas de columnas se aplican a través de los carriles',
    'Task limit: ' => 'Límite de tarea: ',
    'Change to global tag' => 'Cambiar a etiqueta global',
    'Do you really want to make the tag "%s" global?' => '¿Realmente deseas que la etiqueta "%s" sea global?',
    'Enable global tags for this project' => 'Activar etiquetas globales para este proyecto',
    'Group membership(s):' => 'Pertenencia a Grupo(s)',
    '%s is a member of the following group(s): %s' => '%s pertenece al/los siguiente(s) grupo(s): %s',
    '%d/%d group(s) shown' => '%d/%d grupo(s) mostrado(s)',
    'Subtask creation or modification' => 'Creación de subtarea o rectificación',
);
